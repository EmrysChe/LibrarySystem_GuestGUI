...
void library_user_Widget::mouseMoveEvent(QMouseEvent *e)
{
...
void library_user_Widget::mousePressEvent(QMouseEvent *e)
{
        ...
        else
        {
            ...
            else
            {
                while(query.next())
                {
                    ...
                    {
                        qDebug()<<"user ok";
                        gp = new GuestGUIWidget;
                        connect(this,SIGNAL(sendData(int)),gp,SLOT(receiveData(int)));
                        gp->show();
                        emit sendData(ui->acc_num_lineEdit->text().toInt());
                        //qDebug() << ui->acc_num_lineEdit->text().toInt();
                        close();
                        return;
                    }
                    else
