...
#include "../library/register_widget.h"
...
QT_MOC_LITERAL(1, 16, 29), // "on_comfirm_pushButton_clicked"
QT_MOC_LITERAL(2, 46, 0) // ""

    },
    "register_widget\0on_comfirm_pushButton_clicked\0"
    ""
};
...
const QMetaObject register_widget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_register_widget.data,
      qt_meta_data_register_widget,  qt_static_metacall, nullptr, nullptr}
};
...
void *register_widget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_register_widget.stringdata0))
        return static_cast<void*>(const_cast< register_widget*>(this));
