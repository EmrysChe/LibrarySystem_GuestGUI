    ...
    ui(new Ui::GuestGUIWidget)
{
    ...
    userModel->setFilter("account='704265711'");
    userModel->select();
    ...
    userbook1Model->setFilter("account='704265711'");
    ...
    userbook2Model->setFilter("account='704265711'");
...
void GuestGUIWidget::on_borrowButton_clicked()
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                bookdatabuf.name = query.value(0).toString();
                bookdatabuf.id = query.value(1).toString();
                ...
                query.exec("SELECT * FROM user WHERE account = '704265711'");
                ...
                if(userbuf.book1_name == NULL)
                {
                    ...
                    query.exec("UPDATE user SET book1_id = " + bookdatabuf.id + " WHERE account = '704265711'");
                    buf = "'" + bookdatabuf.name + "'";
                    query.exec("UPDATE user SET book1_name = " + buf +" WHERE account = '704265711'");
                    //qDebug() << buf;
                    query.exec("UPDATE user SET book1_borrowDate = date('now') WHERE account = '704265711'");
                    query.exec("UPDATE user SET book1_returnDate = date('now','+60 day') WHERE account = '704265711'");
                    QMessageBox::information(this,NULL,tr("thank you for borrow book, please return it on time."));
                }
                else if(userbuf.book2_name == NULL)
                {
                    //qDebug() << bookdatabuf.id;
                    query.exec("UPDATE user SET book2_id = " + bookdatabuf.id + " WHERE account = '704265711'");
                    buf = "'" + bookdatabuf.name + "'";
                    query.exec("UPDATE user SET book2_name = " + buf +" WHERE account = '704265711'");
                    //qDebug() << buf;
                    query.exec("UPDATE user SET book2_borrowDate = date('now') WHERE account = '704265711'");
                    query.exec("UPDATE user SET book2_returnDate = date('now','+60 day') WHERE account = '704265711'");
                    QMessageBox::information(this,NULL,tr("thank you for borrow book, please return it on time."));
                }
                else
                {
...
void GuestGUIWidget::on_returnButton_clicked()
{
    ...
    else
    {
        ...
        else
        {
            ...
            query2.first();
            bookdatabuf.name = query2.value(0).toString();
            bookdatabuf.id = query2.value(1).toString();
            ...
            query2.exec("SELECT * FROM user WHERE account = '704265711'");
            ...
            {
                query.exec("UPDATE user SET book1_name = NULL WHERE account = '704265711'");
                query.exec("UPDATE user SET book1_id = NULL WHERE account = '704265711'");
                query.exec("UPDATE user SET book1_returnDate = NULL WHERE account = '704265711'");
                query.exec("UPDATE user SET book1_borrowDate = NULL WHERE account = '704265711'");
                QMessageBox::information(this,NULL,tr("thank you for return book !"));
            }
            else if(userbuf.book2_name == ui->searchBookLineEdit->text())
            {
                query.exec("UPDATE user SET book2_name = NULL WHERE account = '704265711'");
                query.exec("UPDATE user SET book2_id = NULL WHERE account = '704265711'");
                query.exec("UPDATE user SET book2_returnDate = NULL WHERE account = '704265711'");
                query.exec("UPDATE user SET book2_borrowDate = NULL WHERE account = '704265711'");
                QMessageBox::information(this,NULL,tr("thank you for return book !"));
            }
            else
            {
